    ...
    <div>
      ...
      <div className="mt-[3rem] pb-2 md:pt-[3rem]">
        <div className="container mx-auto">
          ...
          <h2 className="text-3xl relative md:text-6xl">
          ...
          <div className="mt-10 pb-5 rounded-b-lg flex items-center flex-col gap-10 md:flex-row">
            <div className="w-full mt-3 max-w-xl">
              ...
              <p className="text-xl text-gray-500 mb-8">Chair / Founder</p>
              <h2 className="text-2xl font-medium">Dr. Mark Dzradosi</h2>
              <p className="text-xl text-gray-500 mb-8">ViceChair</p>
              <h2 className="text-2xl font-medium">Mrs. Juliet Gyamfi</h2>
              <p className="text-xl text-gray-500 mb-8">Board member</p>
              <h2 className="text-2xl font-medium">Adelaide O. Dwamena</h2>
              <p className="text-xl text-gray-500 mb-8">Board member</p>
              <h2 className="text-2xl font-medium">Benjamin Ato Quansah</h2>
              <p className="text-xl text-gray-500 mb-8">Treasure</p>
            </div>
          </div>
          <h2 className="text-3xl relative md:text-6xl">
            <span className="relative before:absolute before:w-full before:h-[10px] before:left-0 before:right-0 before:bottom-1 before:bg-blue-600 before:-z-10 md:before:h-[20px] md:before:w-3/4 md:before:bottom-4">
          ...
          <div className="mt-10 pb-5 rounded-b-lg flex items-center flex-col gap-10 md:flex-row">
            <div className="w-full mt-3 max-w-xl">
              ...
              <p className="text-xl text-gray-500 mb-8">C.E.O</p>
              <h2 className="text-2xl font-medium">Akwasi Osei Owusu</h2>
              <p className="text-xl text-gray-500 mb-8">President</p>
              <h2 className="text-2xl font-medium">Benjamin Ato Quansah</h2>
              <p className="text-xl text-gray-500 mb-8">Treasure</p>
              <h2 className="text-2xl font-medium">Kwame Osei Assibey</h2>
              <p className="text-xl text-gray-500 mb-8">Media & Publicity</p>
              <h2 className="text-2xl font-medium">Richard Mumuni</h2>
              <p className="text-xl text-gray-500 mb-8">Media & Publicity</p>
            </div>
          </div>
        </div>
